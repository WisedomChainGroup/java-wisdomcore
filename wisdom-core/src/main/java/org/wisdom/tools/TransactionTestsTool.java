...
public class TransactionTestsTool {
    ...
    public static void getTransactionsInMemoryPool() throws Exception {
    ...
    public static void postTransaction() throws Exception {
        Ed25519PrivateKey privateKey = new Ed25519PrivateKey(Hex.decodeHex(System.getenv("PRIVATE_KEY")));
    ...
    private static void testGetNonce() throws Exception {
        Ed25519PrivateKey privateKey = new Ed25519PrivateKey(Hex.decodeHex(System.getenv("PRIVATE_KEY")));
    ...
    private static CompletableFuture<Response> postTransaction(Transaction tx) {
        try {
            URI uri = new URI(
                    "http",
                    null,
    ...
    private static CompletableFuture<Long> getNonce(String publicKeyHash) throws Exception {
        URI uri = new URI(
                "http",
                null,
                System.getenv("HOST"),
