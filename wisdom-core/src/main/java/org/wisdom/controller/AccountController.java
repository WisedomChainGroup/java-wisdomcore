...
import org.wisdom.db.AccountStateDB;
...
public class AccountController {
    ...
    @Autowired
    private AccountStateDB accountStateDB;
    ...
    public Object getAccount(@RequestParam("blockHash") String blockHash, @RequestParam("publicKeyHash") String publicKeyHash) {
        return accountStateDB.getAccount(Hex.decode(blockHash), Hex.decode(publicKeyHash)).get();
    }
